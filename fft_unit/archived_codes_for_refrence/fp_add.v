...
module fp_add (
    ...
    assign {carry,mant_sum} = (sign_a == sign_b) ? (aligned_mant_a + aligned_mant_b) : (aligned_mant_a > aligned_mant_b) ? (aligned_mant_a - aligned_mant_b) : (aligned_mant_b - aligned_mant_a);
    ...
    always @(*) begin
        ...
        while (temp_mant[23] == 1'b0 && normalized_exponent > 0) begin
