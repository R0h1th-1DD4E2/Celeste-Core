module fft4pt (
   ...
   wire signed [31:0] tr0, ti0, tr1, ti1, tr2, ti2, tr3, ti3;
    ...
    fft_2pt ins1 (clk,xr0, xi0,xr2, xi2, w2r0, w2i0, tr0, ti0, tr1, ti1);
    fft_2pt ins2 (clk,xr1, xi1, xr3, xi3, w2r0, w2i0, tr2, ti2, tr3, ti3);

    // Second stage: Combine 2-point FFTs into a 4-point FFT
    fft_2pt ins3 (clk,tr0, ti0, tr2, ti2, w4r0, w4i0, Xr0, Xi0, Xr2, Xi2);
    fft_2pt ins4 (clk,tr1, ti1, tr3, ti3, w4r1, w4i1, Xr1, Xi1, Xr3, Xi3);
