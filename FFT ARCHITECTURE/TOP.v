...
Register InputBuffer_rg1(
    .clk(clk),
    .rst(rst),
    .in_1_R(Ip_0_Real), .in_1_I(Ip_0_Img), .in_2_R(Ip_1_Real), .in_2_I(Ip_1_Img),
    .in_3_R(Ip_2_Real), .in_3_I(Ip_2_Img), .in_4_R(Ip_3_Real), .in_4_I(Ip_3_Img),
    .in_5_R(Ip_4_Real), .in_5_I(Ip_4_Img), .in_6_R(Ip_5_Real), .in_6_I(Ip_5_Img),
    .in_7_R(Ip_6_Real), .in_7_I(Ip_6_Img), .in_8_R(Ip_7_Real), .in_8_I(Ip_7_Img),
    .in_9_R(Ip_8_Real), .in_9_I(Ip_8_Img), .in_10_R(Ip_9_Real), .in_10_I(Ip_9_Img),
    .in_11_R(Ip_10_Real), .in_11_I(Ip_10_Img), .in_12_R(Ip_11_Real), .in_12_I(Ip_11_Img),
    .in_13_R(Ip_12_Real), .in_13_I(Ip_12_Img), .in_14_R(Ip_13_Real), .in_14_I(Ip_13_Img),
    .in_15_R(Ip_14_Real), .in_15_I(Ip_14_Img), .in_16_R(Ip_15_Real), .in_16_I(Ip_15_Img),
    .in_17_R(Ip_16_Real), .in_17_I(Ip_16_Img), .in_18_R(Ip_17_Real), .in_18_I(Ip_17_Img),
    .in_19_R(Ip_18_Real), .in_19_I(Ip_18_Img), .in_20_R(Ip_19_Real), .in_20_I(Ip_19_Img),
    .in_21_R(Ip_20_Real), .in_21_I(Ip_20_Img), .in_22_R(Ip_21_Real), .in_22_I(Ip_21_Img),
    .in_23_R(Ip_22_Real), .in_23_I(Ip_22_Img), .in_24_R(Ip_23_Real), .in_24_I(Ip_23_Img),
    .in_25_R(Ip_24_Real), .in_25_I(Ip_24_Img), .in_26_R(Ip_25_Real), .in_26_I(Ip_25_Img),
    .in_27_R(Ip_26_Real), .in_27_I(Ip_26_Img), .in_28_R(Ip_27_Real), .in_28_I(Ip_27_Img),
    .in_29_R(Ip_28_Real), .in_29_I(Ip_28_Img), .in_30_R(Ip_29_Real), .in_30_I(Ip_29_Img),
    .in_31_R(Ip_30_Real), .in_31_I(Ip_30_Img), .in_32_R(Ip_31_Real), .in_32_I(Ip_31_Img),
    .in_33_R(Ip_32_Real), .in_33_I(Ip_32_Img), .in_34_R(Ip_33_Real), .in_34_I(Ip_33_Img),
    .in_35_R(Ip_34_Real), .in_35_I(Ip_34_Img), .in_36_R(Ip_35_Real), .in_36_I(Ip_35_Img),
    .in_37_R(Ip_36_Real), .in_37_I(Ip_36_Img), .in_38_R(Ip_37_Real), .in_38_I(Ip_37_Img),
    .in_39_R(Ip_38_Real), .in_39_I(Ip_38_Img), .in_40_R(Ip_39_Real), .in_40_I(Ip_39_Img),
    .in_41_R(Ip_40_Real), .in_41_I(Ip_40_Img), .in_42_R(Ip_41_Real), .in_42_I(Ip_41_Img),
    .in_43_R(Ip_42_Real), .in_43_I(Ip_42_Img), .in_44_R(Ip_43_Real), .in_44_I(Ip_43_Img),
    .in_45_R(Ip_44_Real), .in_45_I(Ip_44_Img), .in_46_R(Ip_45_Real), .in_46_I(Ip_45_Img),
    .in_47_R(Ip_46_Real), .in_47_I(Ip_46_Img), .in_48_R(Ip_47_Real), .in_48_I(Ip_47_Img),
    .in_49_R(Ip_48_Real), .in_49_I(Ip_48_Img), .in_50_R(Ip_49_Real), .in_50_I(Ip_49_Img),
    .in_51_R(Ip_50_Real), .in_51_I(Ip_50_Img), .in_52_R(Ip_51_Real), .in_52_I(Ip_51_Img),
    .in_53_R(Ip_52_Real), .in_53_I(Ip_52_Img), .in_54_R(Ip_53_Real), .in_54_I(Ip_53_Img),
    .in_55_R(Ip_54_Real), .in_55_I(Ip_54_Img), .in_56_R(Ip_55_Real), .in_56_I(Ip_55_Img),
    .in_57_R(Ip_56_Real), .in_57_I(Ip_56_Img), .in_58_R(Ip_57_Real), .in_58_I(Ip_57_Img),
    .in_59_R(Ip_58_Real), .in_59_I(Ip_58_Img), .in_60_R(Ip_59_Real), .in_60_I(Ip_59_Img),
    .in_61_R(Ip_60_Real), .in_61_I(Ip_60_Img), .in_62_R(Ip_61_Real), .in_62_I(Ip_61_Img),
    .in_63_R(Ip_62_Real), .in_63_I(Ip_62_Img), .in_64_R(Ip_63_Real), .in_64_I(Ip_63_Img)
);
...
Register TransposeBuffer_rg2(
    .clk(clk),
    .rst(rst),
    .in_1_R(ftr_0_R), .in_1_I(ftr_0_I), .in_2_R(ftr_1_R), .in_2_I(ftr_1_I),
    .in_3_R(ftr_2_R), .in_3_I(ftr_2_I), .in_4_R(ftr_3_R), .in_4_I(ftr_3_I),
    .in_5_R(ftr_4_R), .in_5_I(ftr_4_I), .in_6_R(ftr_5_R), .in_6_I(ftr_5_I),
    .in_7_R(ftr_6_R), .in_7_I(ftr_6_I), .in_8_R(ftr_7_R), .in_8_I(ftr_7_I),
    .in_9_R(ftr_8_R), .in_9_I(ftr_8_I), .in_10_R(ftr_9_R), .in_10_I(ftr_9_I),
    .in_11_R(ftr_10_R), .in_11_I(ftr_10_I), .in_12_R(ftr_11_R), .in_12_I(ftr_11_I),
    .in_13_R(ftr_12_R), .in_13_I(ftr_12_I), .in_14_R(ftr_13_R), .in_14_I(ftr_13_I),
    .in_15_R(ftr_14_R), .in_15_I(ftr_14_I), .in_16_R(ftr_15_R), .in_16_I(ftr_15_I),
    .in_17_R(ftr_16_R), .in_17_I(ftr_16_I), .in_18_R(ftr_17_R), .in_18_I(ftr_17_I),
    .in_19_R(ftr_18_R), .in_19_I(ftr_18_I), .in_20_R(ftr_19_R), .in_20_I(ftr_19_I),
    .in_21_R(ftr_20_R), .in_21_I(ftr_20_I), .in_22_R(ftr_21_R), .in_22_I(ftr_21_I),
    .in_23_R(ftr_22_R), .in_23_I(ftr_22_I), .in_24_R(ftr_23_R), .in_24_I(ftr_23_I),
    .in_25_R(ftr_24_R), .in_25_I(ftr_24_I), .in_26_R(ftr_25_R), .in_26_I(ftr_25_I),
    .in_27_R(ftr_26_R), .in_27_I(ftr_26_I), .in_28_R(ftr_27_R), .in_28_I(ftr_27_I),
    .in_29_R(ftr_28_R), .in_29_I(ftr_28_I), .in_30_R(ftr_29_R), .in_30_I(ftr_29_I),
    .in_31_R(ftr_30_R), .in_31_I(ftr_30_I), .in_32_R(ftr_31_R), .in_32_I(ftr_31_I),
    .in_33_R(ftr_32_R), .in_33_I(ftr_32_I), .in_34_R(ftr_33_R), .in_34_I(ftr_33_I),
    .in_35_R(ftr_34_R), .in_35_I(ftr_34_I), .in_36_R(ftr_35_R), .in_36_I(ftr_35_I),
    .in_37_R(ftr_36_R), .in_37_I(ftr_36_I), .in_38_R(ftr_37_R), .in_38_I(ftr_37_I),
    .in_39_R(ftr_38_R), .in_39_I(ftr_38_I), .in_40_R(ftr_39_R), .in_40_I(ftr_39_I),
    .in_41_R(ftr_40_R), .in_41_I(ftr_40_I), .in_42_R(ftr_41_R), .in_42_I(ftr_41_I),
    .in_43_R(ftr_42_R), .in_43_I(ftr_42_I), .in_44_R(ftr_43_R), .in_44_I(ftr_43_I),
    .in_45_R(ftr_44_R), .in_45_I(ftr_44_I), .in_46_R(ftr_45_R), .in_46_I(ftr_45_I),
    .in_47_R(ftr_46_R), .in_47_I(ftr_46_I), .in_48_R(ftr_47_R), .in_48_I(ftr_47_I),
    .in_49_R(ftr_48_R), .in_49_I(ftr_48_I), .in_50_R(ftr_49_R), .in_50_I(ftr_49_I),
    .in_51_R(ftr_50_R), .in_51_I(ftr_50_I), .in_52_R(ftr_51_R), .in_52_I(ftr_51_I),
    .in_53_R(ftr_52_R), .in_53_I(ftr_52_I), .in_54_R(ftr_53_R), .in_54_I(ftr_53_I),
    .in_55_R(ftr_54_R), .in_55_I(ftr_54_I), .in_56_R(ftr_55_R), .in_56_I(ftr_55_I),
    .in_57_R(ftr_56_R), .in_57_I(ftr_56_I), .in_58_R(ftr_57_R), .in_58_I(ftr_57_I),
    .in_59_R(ftr_58_R), .in_59_I(ftr_58_I), .in_60_R(ftr_59_R), .in_60_I(ftr_59_I),
    .in_61_R(ftr_60_R), .in_61_I(ftr_60_I), .in_62_R(ftr_61_R), .in_62_I(ftr_61_I),
    .in_63_R(ftr_62_R), .in_63_I(ftr_62_I), .in_64_R(ftr_63_R), .in_64_I(ftr_63_I),



    .out_1_R(rg2_0_R), .out_1_I(rg2_0_I), .out_2_R(rg2_1_R), .out_2_I(rg2_1_I),
    .out_3_R(rg2_2_R), .out_3_I(rg2_2_I), .out_4_R(rg2_3_R), .out_4_I(rg2_3_I),
    .out_5_R(rg2_4_R), .out_5_I(rg2_4_I), .out_6_R(rg2_5_R), .out_6_I(rg2_5_I),
    .out_7_R(rg2_6_R), .out_7_I(rg2_6_I), .out_8_R(rg2_7_R), .out_8_I(rg2_7_I),
    .out_9_R(rg2_8_R), .out_9_I(rg2_8_I), .out_10_R(rg2_9_R), .out_10_I(rg2_9_I),
    .out_11_R(rg2_10_R), .out_11_I(rg2_10_I), .out_12_R(rg2_11_R), .out_12_I(rg2_11_I),
    .out_13_R(rg2_12_R), .out_13_I(rg2_12_I), .out_14_R(rg2_13_R), .out_14_I(rg2_13_I),
    .out_15_R(rg2_14_R), .out_15_I(rg2_14_I), .out_16_R(rg2_15_R), .out_16_I(rg2_15_I),
    .out_17_R(rg2_16_R), .out_17_I(rg2_16_I), .out_18_R(rg2_17_R), .out_18_I(rg2_17_I),
    .out_19_R(rg2_18_R), .out_19_I(rg2_18_I), .out_20_R(rg2_19_R), .out_20_I(rg2_19_I),
    .out_21_R(rg2_20_R), .out_21_I(rg2_20_I), .out_22_R(rg2_21_R), .out_22_I(rg2_21_I),
    .out_23_R(rg2_22_R), .out_23_I(rg2_22_I), .out_24_R(rg2_23_R), .out_24_I(rg2_23_I),
    .out_25_R(rg2_24_R), .out_25_I(rg2_24_I), .out_26_R(rg2_25_R), .out_26_I(rg2_25_I),
    .out_27_R(rg2_26_R), .out_27_I(rg2_26_I), .out_28_R(rg2_27_R), .out_28_I(rg2_27_I),
    .out_29_R(rg2_28_R), .out_29_I(rg2_28_I), .out_30_R(rg2_29_R), .out_30_I(rg2_29_I),
    .out_31_R(rg2_30_R), .out_31_I(rg2_30_I), .out_32_R(rg2_31_R), .out_32_I(rg2_31_I),
    .out_33_R(rg2_32_R), .out_33_I(rg2_32_I), .out_34_R(rg2_33_R), .out_34_I(rg2_33_I),
    .out_35_R(rg2_34_R), .out_35_I(rg2_34_I), .out_36_R(rg2_35_R), .out_36_I(rg2_35_I),
    .out_37_R(rg2_36_R), .out_37_I(rg2_36_I), .out_38_R(rg2_37_R), .out_38_I(rg2_37_I),
    .out_39_R(rg2_38_R), .out_39_I(rg2_38_I), .out_40_R(rg2_39_R), .out_40_I(rg2_39_I),
    .out_41_R(rg2_40_R), .out_41_I(rg2_40_I), .out_42_R(rg2_41_R), .out_42_I(rg2_41_I),
    .out_43_R(rg2_42_R), .out_43_I(rg2_42_I), .out_44_R(rg2_43_R), .out_44_I(rg2_43_I),
    .out_45_R(rg2_44_R), .out_45_I(rg2_44_I), .out_46_R(rg2_45_R), .out_46_I(rg2_45_I),
    .out_47_R(rg2_46_R), .out_47_I(rg2_46_I), .out_48_R(rg2_47_R), .out_48_I(rg2_47_I),
    .out_49_R(rg2_48_R), .out_49_I(rg2_48_I), .out_50_R(rg2_49_R), .out_50_I(rg2_49_I),
    .out_51_R(rg2_50_R), .out_51_I(rg2_50_I), .out_52_R(rg2_51_R), .out_52_I(rg2_51_I),
    .out_53_R(rg2_52_R), .out_53_I(rg2_52_I), .out_54_R(rg2_53_R), .out_54_I(rg2_53_I),
    .out_55_R(rg2_54_R), .out_55_I(rg2_54_I), .out_56_R(rg2_55_R), .out_56_I(rg2_55_I),
    .out_57_R(rg2_56_R), .out_57_I(rg2_56_I), .out_58_R(rg2_57_R), .out_58_I(rg2_57_I),
    .out_59_R(rg2_58_R), .out_59_I(rg2_58_I), .out_60_R(rg2_59_R), .out_60_I(rg2_59_I),
    .out_61_R(rg2_60_R), .out_61_I(rg2_60_I), .out_62_R(rg2_61_R), .out_62_I(rg2_61_I),
    .out_63_R(rg2_62_R), .out_63_I(rg2_62_I), .out_64_R(rg2_63_R), .out_64_I(rg2_63_I)
);
...
SpectralRegister SpectralDataBuffer(
    .clk(clk),
    .rst(rst),
    .in_1_R(ftc_0_R), .in_1_I(ftc_0_I), .in_2_R(ftc_1_R), .in_2_I(ftc_1_I),
    .in_3_R(ftc_2_R), .in_3_I(ftc_2_I), .in_4_R(ftc_3_R), .in_4_I(ftc_3_I),
    .in_5_R(ftc_4_R), .in_5_I(ftc_4_I), .in_6_R(ftc_5_R), .in_6_I(ftc_5_I),
    .in_7_R(ftc_6_R), .in_7_I(ftc_6_I), .in_8_R(ftc_7_R), .in_8_I(ftc_7_I),
    .in_9_R(ftc_8_R), .in_9_I(ftc_8_I), .in_10_R(ftc_9_R), .in_10_I(ftc_9_I),
    .in_11_R(ftc_10_R), .in_11_I(ftc_10_I), .in_12_R(ftc_11_R), .in_12_I(ftc_11_I),
    .in_13_R(ftc_12_R), .in_13_I(ftc_12_I), .in_14_R(ftc_13_R), .in_14_I(ftc_13_I),
    .in_15_R(ftc_14_R), .in_15_I(ftc_14_I), .in_16_R(ftc_15_R), .in_16_I(ftc_15_I),
    .in_17_R(ftc_16_R), .in_17_I(ftc_16_I), .in_18_R(ftc_17_R), .in_18_I(ftc_17_I),
    .in_19_R(ftc_18_R), .in_19_I(ftc_18_I), .in_20_R(ftc_19_R), .in_20_I(ftc_19_I),
    .in_21_R(ftc_20_R), .in_21_I(ftc_20_I), .in_22_R(ftc_21_R), .in_22_I(ftc_21_I),
    .in_23_R(ftc_22_R), .in_23_I(ftc_22_I), .in_24_R(ftc_23_R), .in_24_I(ftc_23_I),
    .in_25_R(ftc_24_R), .in_25_I(ftc_24_I), .in_26_R(ftc_25_R), .in_26_I(ftc_25_I),
    .in_27_R(ftc_26_R), .in_27_I(ftc_26_I), .in_28_R(ftc_27_R), .in_28_I(ftc_27_I),
    .in_29_R(ftc_28_R), .in_29_I(ftc_28_I), .in_30_R(ftc_29_R), .in_30_I(ftc_29_I),
    .in_31_R(ftc_30_R), .in_31_I(ftc_30_I), .in_32_R(ftc_31_R), .in_32_I(ftc_31_I),
    .in_33_R(ftc_32_R), .in_33_I(ftc_32_I), .in_34_R(ftc_33_R), .in_34_I(ftc_33_I),
    .in_35_R(ftc_34_R), .in_35_I(ftc_34_I), .in_36_R(ftc_35_R), .in_36_I(ftc_35_I),
    .in_37_R(ftc_36_R), .in_37_I(ftc_36_I), .in_38_R(ftc_37_R), .in_38_I(ftc_37_I),
    .in_39_R(ftc_38_R), .in_39_I(ftc_38_I), .in_40_R(ftc_39_R), .in_40_I(ftc_39_I),
    .in_41_R(ftc_40_R), .in_41_I(ftc_40_I), .in_42_R(ftc_41_R), .in_42_I(ftc_41_I),
    .in_43_R(ftc_42_R), .in_43_I(ftc_42_I), .in_44_R(ftc_43_R), .in_44_I(ftc_43_I),
    .in_45_R(ftc_44_R), .in_45_I(ftc_44_I), .in_46_R(ftc_45_R), .in_46_I(ftc_45_I),
    .in_47_R(ftc_46_R), .in_47_I(ftc_46_I), .in_48_R(ftc_47_R), .in_48_I(ftc_47_I),
    .in_49_R(ftc_48_R), .in_49_I(ftc_48_I), .in_50_R(ftc_49_R), .in_50_I(ftc_49_I),
    .in_51_R(ftc_50_R), .in_51_I(ftc_50_I), .in_52_R(ftc_51_R), .in_52_I(ftc_51_I),
    .in_53_R(ftc_52_R), .in_53_I(ftc_52_I), .in_54_R(ftc_53_R), .in_54_I(ftc_53_I),
    .in_55_R(ftc_54_R), .in_55_I(ftc_54_I), .in_56_R(ftc_55_R), .in_56_I(ftc_55_I),
    .in_57_R(ftc_56_R), .in_57_I(ftc_56_I), .in_58_R(ftc_57_R), .in_58_I(ftc_57_I),
    .in_59_R(ftc_58_R), .in_59_I(ftc_58_I), .in_60_R(ftc_59_R), .in_60_I(ftc_59_I),
    .in_61_R(ftc_60_R), .in_61_I(ftc_60_I), .in_62_R(ftc_61_R), .in_62_I(ftc_61_I),
    .in_63_R(ftc_62_R), .in_63_I(ftc_62_I), .in_64_R(ftc_63_R), .in_64_I(ftc_63_I),

    .out_1_R(rg3_0_R), .out_1_I(rg3_0_I), .out_2_R(rg3_1_R), .out_2_I(rg3_1_I),
    .out_3_R(rg3_2_R), .out_3_I(rg3_2_I), .out_4_R(rg3_3_R), .out_4_I(rg3_3_I),
    .out_5_R(rg3_4_R), .out_5_I(rg3_4_I), .out_6_R(rg3_5_R), .out_6_I(rg3_5_I),
    .out_7_R(rg3_6_R), .out_7_I(rg3_6_I), .out_8_R(rg3_7_R), .out_8_I(rg3_7_I),
    .out_9_R(rg3_8_R), .out_9_I(rg3_8_I), .out_10_R(rg3_9_R), .out_10_I(rg3_9_I),
    .out_11_R(rg3_10_R), .out_11_I(rg3_10_I), .out_12_R(rg3_11_R), .out_12_I(rg3_11_I),
    .out_13_R(rg3_12_R), .out_13_I(rg3_12_I), .out_14_R(rg3_13_R), .out_14_I(rg3_13_I),
    .out_15_R(rg3_14_R), .out_15_I(rg3_14_I), .out_16_R(rg3_15_R), .out_16_I(rg3_15_I),
    .out_17_R(rg3_16_R), .out_17_I(rg3_16_I), .out_18_R(rg3_17_R), .out_18_I(rg3_17_I),
    .out_19_R(rg3_18_R), .out_19_I(rg3_18_I), .out_20_R(rg3_19_R), .out_20_I(rg3_19_I),
    .out_21_R(rg3_20_R), .out_21_I(rg3_20_I), .out_22_R(rg3_21_R), .out_22_I(rg3_21_I),
    .out_23_R(rg3_22_R), .out_23_I(rg3_22_I), .out_24_R(rg3_23_R), .out_24_I(rg3_23_I),
    .out_25_R(rg3_24_R), .out_25_I(rg3_24_I), .out_26_R(rg3_25_R), .out_26_I(rg3_25_I),
    .out_27_R(rg3_26_R), .out_27_I(rg3_26_I), .out_28_R(rg3_27_R), .out_28_I(rg3_27_I),
    .out_29_R(rg3_28_R), .out_29_I(rg3_28_I), .out_30_R(rg3_29_R), .out_30_I(rg3_29_I),
    .out_31_R(rg3_30_R), .out_31_I(rg3_30_I), .out_32_R(rg3_31_R), .out_32_I(rg3_31_I),
    .out_33_R(rg3_32_R), .out_33_I(rg3_32_I), .out_34_R(rg3_33_R), .out_34_I(rg3_33_I),
    .out_35_R(rg3_34_R), .out_35_I(rg3_34_I), .out_36_R(rg3_35_R), .out_36_I(rg3_35_I),
    .out_37_R(rg3_36_R), .out_37_I(rg3_36_I), .out_38_R(rg3_37_R), .out_38_I(rg3_37_I),
    .out_39_R(rg3_38_R), .out_39_I(rg3_38_I), .out_40_R(rg3_39_R), .out_40_I(rg3_39_I),
    .out_41_R(rg3_40_R), .out_41_I(rg3_40_I), .out_42_R(rg3_41_R), .out_42_I(rg3_41_I),
    .out_43_R(rg3_42_R), .out_43_I(rg3_42_I), .out_44_R(rg3_43_R), .out_44_I(rg3_43_I),
    .out_45_R(rg3_44_R), .out_45_I(rg3_44_I), .out_46_R(rg3_45_R), .out_46_I(rg3_45_I),
    .out_47_R(rg3_46_R), .out_47_I(rg3_46_I), .out_48_R(rg3_47_R), .out_48_I(rg3_47_I),
    .out_49_R(rg3_48_R), .out_49_I(rg3_48_I), .out_50_R(rg3_49_R), .out_50_I(rg3_49_I),
    .out_51_R(rg3_50_R), .out_51_I(rg3_50_I), .out_52_R(rg3_51_R), .out_52_I(rg3_51_I),
    .out_53_R(rg3_52_R), .out_53_I(rg3_52_I), .out_54_R(rg3_53_R), .out_54_I(rg3_53_I),
    .out_55_R(rg3_54_R), .out_55_I(rg3_54_I), .out_56_R(rg3_55_R), .out_56_I(rg3_55_I),
    .out_57_R(rg3_56_R), .out_57_I(rg3_56_I), .out_58_R(rg3_57_R), .out_58_I(rg3_57_I),
    .out_59_R(rg3_58_R), .out_59_I(rg3_58_I), .out_60_R(rg3_59_R), .out_60_I(rg3_59_I),
    .out_61_R(rg3_60_R), .out_61_I(rg3_60_I), .out_62_R(rg3_61_R), .out_62_I(rg3_61_I),
    .out_63_R(rg3_62_R), .out_63_I(rg3_62_I), .out_64_R(rg3_63_R), .out_64_I(rg3_63_I)
);
...
Register TransposeBuffer2_rg5(
    .clk(clk),
    .rst(rst),
    .in_1_R(iftc_0_R), .in_1_I(iftc_0_I), .in_2_R(iftc_1_R), .in_2_I(iftc_1_I),
    .in_3_R(iftc_2_R), .in_3_I(iftc_2_I), .in_4_R(iftc_3_R), .in_4_I(iftc_3_I),
    .in_5_R(iftc_4_R), .in_5_I(iftc_4_I), .in_6_R(iftc_5_R), .in_6_I(iftc_5_I),
    .in_7_R(iftc_6_R), .in_7_I(iftc_6_I), .in_8_R(iftc_7_R), .in_8_I(iftc_7_I),
    .in_9_R(iftc_8_R), .in_9_I(iftc_8_I), .in_10_R(iftc_9_R), .in_10_I(iftc_9_I),
    .in_11_R(iftc_10_R), .in_11_I(iftc_10_I), .in_12_R(iftc_11_R), .in_12_I(iftc_11_I),
    .in_13_R(iftc_12_R), .in_13_I(iftc_12_I), .in_14_R(iftc_13_R), .in_14_I(iftc_13_I),
    .in_15_R(iftc_14_R), .in_15_I(iftc_14_I), .in_16_R(iftc_15_R), .in_16_I(iftc_15_I),
    .in_17_R(iftc_16_R), .in_17_I(iftc_16_I), .in_18_R(iftc_17_R), .in_18_I(iftc_17_I),
    .in_19_R(iftc_18_R), .in_19_I(iftc_18_I), .in_20_R(iftc_19_R), .in_20_I(iftc_19_I),
    .in_21_R(iftc_20_R), .in_21_I(iftc_20_I), .in_22_R(iftc_21_R), .in_22_I(iftc_21_I),
    .in_23_R(iftc_22_R), .in_23_I(iftc_22_I), .in_24_R(iftc_23_R), .in_24_I(iftc_23_I),
    .in_25_R(iftc_24_R), .in_25_I(iftc_24_I), .in_26_R(iftc_25_R), .in_26_I(iftc_25_I),
    .in_27_R(iftc_26_R), .in_27_I(iftc_26_I), .in_28_R(iftc_27_R), .in_28_I(iftc_27_I),
    .in_29_R(iftc_28_R), .in_29_I(iftc_28_I), .in_30_R(iftc_29_R), .in_30_I(iftc_29_I),
    .in_31_R(iftc_30_R), .in_31_I(iftc_30_I), .in_32_R(iftc_31_R), .in_32_I(iftc_31_I),
    .in_33_R(iftc_32_R), .in_33_I(iftc_32_I), .in_34_R(iftc_33_R), .in_34_I(iftc_33_I),
    .in_35_R(iftc_34_R), .in_35_I(iftc_34_I), .in_36_R(iftc_35_R), .in_36_I(iftc_35_I),
    .in_37_R(iftc_36_R), .in_37_I(iftc_36_I), .in_38_R(iftc_37_R), .in_38_I(iftc_37_I),
    .in_39_R(iftc_38_R), .in_39_I(iftc_38_I), .in_40_R(iftc_39_R), .in_40_I(iftc_39_I),
    .in_41_R(iftc_40_R), .in_41_I(iftc_40_I), .in_42_R(iftc_41_R), .in_42_I(iftc_41_I),
    .in_43_R(iftc_42_R), .in_43_I(iftc_42_I), .in_44_R(iftc_43_R), .in_44_I(iftc_43_I),
    .in_45_R(iftc_44_R), .in_45_I(iftc_44_I), .in_46_R(iftc_45_R), .in_46_I(iftc_45_I),
    .in_47_R(iftc_46_R), .in_47_I(iftc_46_I), .in_48_R(iftc_47_R), .in_48_I(iftc_47_I),
    .in_49_R(iftc_48_R), .in_49_I(iftc_48_I), .in_50_R(iftc_49_R), .in_50_I(iftc_49_I),
    .in_51_R(iftc_50_R), .in_51_I(iftc_50_I), .in_52_R(iftc_51_R), .in_52_I(iftc_51_I),
    .in_53_R(iftc_52_R), .in_53_I(iftc_52_I), .in_54_R(iftc_53_R), .in_54_I(iftc_53_I),
    .in_55_R(iftc_54_R), .in_55_I(iftc_54_I), .in_56_R(iftc_55_R), .in_56_I(iftc_55_I),
    .in_57_R(iftc_56_R), .in_57_I(iftc_56_I), .in_58_R(iftc_57_R), .in_58_I(iftc_57_I),
    .in_59_R(iftc_58_R), .in_59_I(iftc_58_I), .in_60_R(iftc_59_R), .in_60_I(iftc_59_I),
    .in_61_R(iftc_60_R), .in_61_I(iftc_60_I), .in_62_R(iftc_61_R), .in_62_I(iftc_61_I),
    .in_63_R(iftc_62_R), .in_63_I(iftc_62_I), .in_64_R(iftc_63_R), .in_64_I(iftc_63_I),

    .out_1_R(rg5_0_R), .out_1_I(rg5_0_I), .out_2_R(rg5_1_R), .out_2_I(rg5_1_I),
    .out_3_R(rg5_2_R), .out_3_I(rg5_2_I), .out_4_R(rg5_3_R), .out_4_I(rg5_3_I),
    .out_5_R(rg5_4_R), .out_5_I(rg5_4_I), .out_6_R(rg5_5_R), .out_6_I(rg5_5_I),
    .out_7_R(rg5_6_R), .out_7_I(rg5_6_I), .out_8_R(rg5_7_R), .out_8_I(rg5_7_I),
    .out_9_R(rg5_8_R), .out_9_I(rg5_8_I), .out_10_R(rg5_9_R), .out_10_I(rg5_9_I),
    .out_11_R(rg5_10_R), .out_11_I(rg5_10_I), .out_12_R(rg5_11_R), .out_12_I(rg5_11_I),
    .out_13_R(rg5_12_R), .out_13_I(rg5_12_I), .out_14_R(rg5_13_R), .out_14_I(rg5_13_I),
    .out_15_R(rg5_14_R), .out_15_I(rg5_14_I), .out_16_R(rg5_15_R), .out_16_I(rg5_15_I),
    .out_17_R(rg5_16_R), .out_17_I(rg5_16_I), .out_18_R(rg5_17_R), .out_18_I(rg5_17_I),
    .out_19_R(rg5_18_R), .out_19_I(rg5_18_I), .out_20_R(rg5_19_R), .out_20_I(rg5_19_I),
    .out_21_R(rg5_20_R), .out_21_I(rg5_20_I), .out_22_R(rg5_21_R), .out_22_I(rg5_21_I),
    .out_23_R(rg5_22_R), .out_23_I(rg5_22_I), .out_24_R(rg5_23_R), .out_24_I(rg5_23_I),
    .out_25_R(rg5_24_R), .out_25_I(rg5_24_I), .out_26_R(rg5_25_R), .out_26_I(rg5_25_I),
    .out_27_R(rg5_26_R), .out_27_I(rg5_26_I), .out_28_R(rg5_27_R), .out_28_I(rg5_27_I),
    .out_29_R(rg5_28_R), .out_29_I(rg5_28_I), .out_30_R(rg5_29_R), .out_30_I(rg5_29_I),
    .out_31_R(rg5_30_R), .out_31_I(rg5_30_I), .out_32_R(rg5_31_R), .out_32_I(rg5_31_I),
    .out_33_R(rg5_32_R), .out_33_I(rg5_32_I), .out_34_R(rg5_33_R), .out_34_I(rg5_33_I),
    .out_35_R(rg5_34_R), .out_35_I(rg5_34_I), .out_36_R(rg5_35_R), .out_36_I(rg5_35_I),
    .out_37_R(rg5_36_R), .out_37_I(rg5_36_I), .out_38_R(rg5_37_R), .out_38_I(rg5_37_I),
    .out_39_R(rg5_38_R), .out_39_I(rg5_38_I), .out_40_R(rg5_39_R), .out_40_I(rg5_39_I),
    .out_41_R(rg5_40_R), .out_41_I(rg5_40_I), .out_42_R(rg5_41_R), .out_42_I(rg5_41_I),
    .out_43_R(rg5_42_R), .out_43_I(rg5_42_I), .out_44_R(rg5_43_R), .out_44_I(rg5_43_I),
    .out_45_R(rg5_44_R), .out_45_I(rg5_44_I), .out_46_R(rg5_45_R), .out_46_I(rg5_45_I),
    .out_47_R(rg5_46_R), .out_47_I(rg5_46_I), .out_48_R(rg5_47_R), .out_48_I(rg5_47_I),
    .out_49_R(rg5_48_R), .out_49_I(rg5_48_I), .out_50_R(rg5_49_R), .out_50_I(rg5_49_I),
    .out_51_R(rg5_50_R), .out_51_I(rg5_50_I), .out_52_R(rg5_51_R), .out_52_I(rg5_51_I),
    .out_53_R(rg5_52_R), .out_53_I(rg5_52_I), .out_54_R(rg5_53_R), .out_54_I(rg5_53_I),
    .out_55_R(rg5_54_R), .out_55_I(rg5_54_I), .out_56_R(rg5_55_R), .out_56_I(rg5_55_I),
    .out_57_R(rg5_56_R), .out_57_I(rg5_56_I), .out_58_R(rg5_57_R), .out_58_I(rg5_57_I),
    .out_59_R(rg5_58_R), .out_59_I(rg5_58_I), .out_60_R(rg5_59_R), .out_60_I(rg5_59_I),
    .out_61_R(rg5_60_R), .out_61_I(rg5_60_I), .out_62_R(rg5_61_R), .out_62_I(rg5_61_I),
    .out_63_R(rg5_62_R), .out_63_I(rg5_62_I), .out_64_R(rg5_63_R), .out_64_I(rg5_63_I)
);
...
Register OutputBuffer(
    .clk(clk),
    .rst(rst),
    .in_1_R(iftr0_R), .in_1_I(iftr0_I), .in_2_R(iftr1_R), .in_2_I(iftr1_I),
    .in_3_R(iftr2_R), .in_3_I(iftr2_I), .in_4_R(iftr3_R), .in_4_I(iftr3_I),
    .in_5_R(iftr4_R), .in_5_I(iftr4_I), .in_6_R(iftr5_R), .in_6_I(iftr5_I),
    .in_7_R(iftr6_R), .in_7_I(iftr6_I), .in_8_R(iftr7_R), .in_8_I(iftr7_I),
    .in_9_R(iftr8_R), .in_9_I(iftr8_I), .in_10_R(iftr9_R), .in_10_I(iftr9_I),
    .in_11_R(iftr10_R), .in_11_I(iftr10_I), .in_12_R(iftr11_R), .in_12_I(iftr11_I),
    .in_13_R(iftr12_R), .in_13_I(iftr12_I), .in_14_R(iftr13_R), .in_14_I(iftr13_I),
    .in_15_R(iftr14_R), .in_15_I(iftr14_I), .in_16_R(iftr15_R), .in_16_I(iftr15_I),
    .in_17_R(iftr16_R), .in_17_I(iftr16_I), .in_18_R(iftr17_R), .in_18_I(iftr17_I),
    .in_19_R(iftr18_R), .in_19_I(iftr18_I), .in_20_R(iftr19_R), .in_20_I(iftr19_I),
    .in_21_R(iftr20_R), .in_21_I(iftr20_I), .in_22_R(iftr21_R), .in_22_I(iftr21_I),
    .in_23_R(iftr22_R), .in_23_I(iftr22_I), .in_24_R(iftr23_R), .in_24_I(iftr23_I),
    .in_25_R(iftr24_R), .in_25_I(iftr24_I), .in_26_R(iftr25_R), .in_26_I(iftr25_I),
    .in_27_R(iftr26_R), .in_27_I(iftr26_I), .in_28_R(iftr27_R), .in_28_I(iftr27_I),
    .in_29_R(iftr28_R), .in_29_I(iftr28_I), .in_30_R(iftr29_R), .in_30_I(iftr29_I),
    .in_31_R(iftr30_R), .in_31_I(iftr30_I), .in_32_R(iftr31_R), .in_32_I(iftr31_I),
    .in_33_R(iftr32_R), .in_33_I(iftr32_I), .in_34_R(iftr33_R), .in_34_I(iftr33_I),
    .in_35_R(iftr34_R), .in_35_I(iftr34_I), .in_36_R(iftr35_R), .in_36_I(iftr35_I),
    .in_37_R(iftr36_R), .in_37_I(iftr36_I), .in_38_R(iftr37_R), .in_38_I(iftr37_I),
    .in_39_R(iftr38_R), .in_39_I(iftr38_I), .in_40_R(iftr39_R), .in_40_I(iftr39_I),
    .in_41_R(iftr40_R), .in_41_I(iftr40_I), .in_42_R(iftr41_R), .in_42_I(iftr41_I),
    .in_43_R(iftr42_R), .in_43_I(iftr42_I), .in_44_R(iftr43_R), .in_44_I(iftr43_I),
    .in_45_R(iftr44_R), .in_45_I(iftr44_I), .in_46_R(iftr45_R), .in_46_I(iftr45_I),
    .in_47_R(iftr46_R), .in_47_I(iftr46_I), .in_48_R(iftr47_R), .in_48_I(iftr47_I),
    .in_49_R(iftr48_R), .in_49_I(iftr48_I), .in_50_R(iftr49_R), .in_50_I(iftr49_I),
    .in_51_R(iftr50_R), .in_51_I(iftr50_I), .in_52_R(iftr51_R), .in_52_I(iftr51_I),
    .in_53_R(iftr52_R), .in_53_I(iftr52_I), .in_54_R(iftr53_R), .in_54_I(iftr53_I),
    .in_55_R(iftr54_R), .in_55_I(iftr54_I), .in_56_R(iftr55_R), .in_56_I(iftr55_I),
    .in_57_R(iftr56_R), .in_57_I(iftr56_I), .in_58_R(iftr57_R), .in_58_I(iftr57_I),
    .in_59_R(iftr58_R), .in_59_I(iftr58_I), .in_60_R(iftr59_R), .in_60_I(iftr59_I),
    .in_61_R(iftr60_R), .in_61_I(iftr60_I), .in_62_R(iftr61_R), .in_62_I(iftr61_I),
    .in_63_R(iftr62_R), .in_63_I(iftr62_I), .in_64_R(iftr63_R), .in_64_I(iftr63_I),

    .out_1_R(Op_0_Real), .out_1_I(Op_0_Img), .out_2_R(Op_1_Real), .out_2_I(Op_1_Img),
    .out_3_R(Op_2_Real), .out_3_I(Op_2_Img), .out_4_R(Op_3_Real), .out_4_I(Op_3_Img),
    .out_5_R(Op_4_Real), .out_5_I(Op_4_Img), .out_6_R(Op_5_Real), .out_6_I(Op_5_Img),
    .out_7_R(Op_6_Real), .out_7_I(Op_6_Img), .out_8_R(Op_7_Real), .out_8_I(Op_7_Img),
    .out_9_R(Op_8_Real), .out_9_I(Op_8_Img), .out_10_R(Op_9_Real), .out_10_I(Op_9_Img),
    .out_11_R(Op_10_Real), .out_11_I(Op_10_Img), .out_12_R(Op_11_Real), .out_12_I(Op_11_Img),
    .out_13_R(Op_12_Real), .out_13_I(Op_12_Img), .out_14_R(Op_13_Real), .out_14_I(Op_13_Img),
    .out_15_R(Op_14_Real), .out_15_I(Op_14_Img), .out_16_R(Op_15_Real), .out_16_I(Op_15_Img),
    .out_17_R(Op_16_Real), .out_17_I(Op_16_Img), .out_18_R(Op_17_Real), .out_18_I(Op_17_Img),
    .out_19_R(Op_18_Real), .out_19_I(Op_18_Img), .out_20_R(Op_19_Real), .out_20_I(Op_19_Img),
    .out_21_R(Op_20_Real), .out_21_I(Op_20_Img), .out_22_R(Op_21_Real), .out_22_I(Op_21_Img),
    .out_23_R(Op_22_Real), .out_23_I(Op_22_Img), .out_24_R(Op_23_Real), .out_24_I(Op_23_Img),
    .out_25_R(Op_24_Real), .out_25_I(Op_24_Img), .out_26_R(Op_25_Real), .out_26_I(Op_25_Img),
    .out_27_R(Op_26_Real), .out_27_I(Op_26_Img), .out_28_R(Op_27_Real), .out_28_I(Op_27_Img),
    .out_29_R(Op_28_Real), .out_29_I(Op_28_Img), .out_30_R(Op_29_Real), .out_30_I(Op_29_Img),
    .out_31_R(Op_30_Real), .out_31_I(Op_30_Img), .out_32_R(Op_31_Real), .out_32_I(Op_31_Img),
    .out_33_R(Op_32_Real), .out_33_I(Op_32_Img), .out_34_R(Op_33_Real), .out_34_I(Op_33_Img),
    .out_35_R(Op_34_Real), .out_35_I(Op_34_Img), .out_36_R(Op_35_Real), .out_36_I(Op_35_Img),
    .out_37_R(Op_36_Real), .out_37_I(Op_36_Img), .out_38_R(Op_37_Real), .out_38_I(Op_37_Img),
    .out_39_R(Op_38_Real), .out_39_I(Op_38_Img), .out_40_R(Op_39_Real), .out_40_I(Op_39_Img),
    .out_41_R(Op_40_Real), .out_41_I(Op_40_Img), .out_42_R(Op_41_Real), .out_42_I(Op_41_Img),
    .out_43_R(Op_42_Real), .out_43_I(Op_42_Img), .out_44_R(Op_43_Real), .out_44_I(Op_43_Img),
    .out_45_R(Op_44_Real), .out_45_I(Op_44_Img), .out_46_R(Op_45_Real), .out_46_I(Op_45_Img),
    .out_47_R(Op_46_Real), .out_47_I(Op_46_Img), .out_48_R(Op_47_Real), .out_48_I(Op_47_Img),
    .out_49_R(Op_48_Real), .out_49_I(Op_48_Img), .out_50_R(Op_49_Real), .out_50_I(Op_49_Img),
    .out_51_R(Op_50_Real), .out_51_I(Op_50_Img), .out_52_R(Op_51_Real), .out_52_I(Op_51_Img),
    .out_53_R(Op_52_Real), .out_53_I(Op_52_Img), .out_54_R(Op_53_Real), .out_54_I(Op_53_Img),
    .out_55_R(Op_54_Real), .out_55_I(Op_54_Img), .out_56_R(Op_55_Real), .out_56_I(Op_55_Img),
    .out_57_R(Op_56_Real), .out_57_I(Op_56_Img), .out_58_R(Op_57_Real), .out_58_I(Op_57_Img),
    .out_59_R(Op_58_Real), .out_59_I(Op_58_Img), .out_60_R(Op_59_Real), .out_60_I(Op_59_Img),
    .out_61_R(Op_60_Real), .out_61_I(Op_60_Img), .out_62_R(Op_61_Real), .out_62_I(Op_61_Img),
    .out_63_R(Op_62_Real), .out_63_I(Op_62_Img), .out_64_R(Op_63_Real), .out_64_I(Op_63_Img)
);
endmodule