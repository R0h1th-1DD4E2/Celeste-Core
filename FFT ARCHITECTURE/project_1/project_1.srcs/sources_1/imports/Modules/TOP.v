...
ker_reg kerreg(.clk(clk),.rst(rst),.ker_sel(ker_sel), .ker_r0(ker_in_0_R),.ker_i0(ker_in_0_I),
...
KernelMultiplier inst1(
    .x0_real_in(rg3_0_R), .x0_imag_in(rg3_0_I), .x1_real_in(rg3_1_R), .x1_imag_in(rg3_1_I), 
    .x2_real_in(rg3_2_R), .x2_imag_in(rg3_2_I), .x3_real_in(rg3_3_R), .x3_imag_in(rg3_3_I),
    .x4_real_in(rg3_4_R), .x4_imag_in(rg3_4_I), .x5_real_in(rg3_5_R), .x5_imag_in(rg3_5_I),
    .x6_real_in(rg3_6_R), .x6_imag_in(rg3_6_I), .x7_real_in(rg3_7_R), .x7_imag_in(rg3_7_I),
    .x8_real_in(rg3_8_R), .x8_imag_in(rg3_8_I), .x9_real_in(rg3_9_R), .x9_imag_in(rg3_9_I),
    .x10_real_in(rg3_10_R), .x10_imag_in(rg3_10_I), .x11_real_in(rg3_11_R), .x11_imag_in(rg3_11_I),
    .x12_real_in(rg3_12_R), .x12_imag_in(rg3_12_I), .x13_real_in(rg3_13_R), .x13_imag_in(rg3_13_I),
    .x14_real_in(rg3_14_R), .x14_imag_in(rg3_14_I), .x15_real_in(rg3_15_R), .x15_imag_in(rg3_15_I),
    .x16_real_in(rg3_16_R), .x16_imag_in(rg3_16_I), .x17_real_in(rg3_17_R), .x17_imag_in(rg3_17_I),
    .x18_real_in(rg3_18_R), .x18_imag_in(rg3_18_I), .x19_real_in(rg3_19_R), .x19_imag_in(rg3_19_I), 
    .x20_real_in(rg3_20_R), .x20_imag_in(rg3_20_I), .x21_real_in(rg3_21_R), .x21_imag_in(rg3_21_I),
    .x22_real_in(rg3_22_R), .x22_imag_in(rg3_22_I), .x23_real_in(rg3_23_R), .x23_imag_in(rg3_23_I),
    .x24_real_in(rg3_24_R), .x24_imag_in(rg3_24_I), .x25_real_in(rg3_25_R), .x25_imag_in(rg3_25_I),
    .x26_real_in(rg3_26_R), .x26_imag_in(rg3_26_I), .x27_real_in(rg3_27_R), .x27_imag_in(rg3_27_I),
    .x28_real_in(rg3_28_R), .x28_imag_in(rg3_28_I), .x29_real_in(rg3_29_R), .x29_imag_in(rg3_29_I),
    .x30_real_in(rg3_30_R), .x30_imag_in(rg3_30_I), .x31_real_in(rg3_31_R), .x31_imag_in(rg3_31_I),
    .x32_real_in(rg3_32_R), .x32_imag_in(rg3_32_I), .x33_real_in(rg3_33_R), .x33_imag_in(rg3_33_I),
    .x34_real_in(rg3_34_R), .x34_imag_in(rg3_34_I), .x35_real_in(rg3_35_R), .x35_imag_in(rg3_35_I),
    .x36_real_in(rg3_36_R), .x36_imag_in(rg3_36_I), .x37_real_in(rg3_37_R), .x37_imag_in(rg3_37_I),
    .x38_real_in(rg3_38_R), .x38_imag_in(rg3_38_I), .x39_real_in(rg3_39_R), .x39_imag_in(rg3_39_I),
    .x40_real_in(rg3_40_R), .x40_imag_in(rg3_40_I), .x41_real_in(rg3_41_R), .x41_imag_in(rg3_41_I),
    .x42_real_in(rg3_42_R), .x42_imag_in(rg3_42_I), .x43_real_in(rg3_43_R), .x43_imag_in(rg3_43_I),
    .x44_real_in(rg3_44_R), .x44_imag_in(rg3_44_I), .x45_real_in(rg3_45_R), .x45_imag_in(rg3_45_I),
    .x46_real_in(rg3_46_R), .x46_imag_in(rg3_46_I), .x47_real_in(rg3_47_R), .x47_imag_in(rg3_47_I),
    .x48_real_in(rg3_48_R), .x48_imag_in(rg3_48_I), .x49_real_in(rg3_49_R), .x49_imag_in(rg3_49_I),
    .x50_real_in(rg3_50_R), .x50_imag_in(rg3_50_I), .x51_real_in(rg3_51_R), .x51_imag_in(rg3_51_I),
    .x52_real_in(rg3_52_R), .x52_imag_in(rg3_52_I), .x53_real_in(rg3_53_R), .x53_imag_in(rg3_53_I),
    .x54_real_in(rg3_54_R), .x54_imag_in(rg3_54_I), .x55_real_in(rg3_55_R), .x55_imag_in(rg3_55_I),
    .x56_real_in(rg3_56_R), .x56_imag_in(rg3_56_I), .x57_real_in(rg3_57_R), .x57_imag_in(rg3_57_I),
    .x58_real_in(rg3_58_R), .x58_imag_in(rg3_58_I), .x59_real_in(rg3_59_R), .x59_imag_in(rg3_59_I),
    .x60_real_in(rg3_60_R), .x60_imag_in(rg3_60_I), .x61_real_in(rg3_61_R), .x61_imag_in(rg3_61_I),
    .x62_real_in(rg3_62_R), .x62_imag_in(rg3_62_I), .x63_real_in(rg3_63_R), .x63_imag_in(rg3_63_I),

    .y0_real_in(ker_in_0_R), .y0_imag_in(ker_in_0_I), .y1_real_in(ker_in_1_R), .y1_imag_in(ker_in_1_I),
    .y2_real_in(ker_in_2_R), .y2_imag_in(ker_in_2_I), .y3_real_in(ker_in_3_R), .y3_imag_in(ker_in_3_I),
    .y4_real_in(ker_in_4_R), .y4_imag_in(ker_in_4_I), .y5_real_in(ker_in_5_R), .y5_imag_in(ker_in_5_I),
    .y6_real_in(ker_in_6_R), .y6_imag_in(ker_in_6_I), .y7_real_in(ker_in_7_R), .y7_imag_in(ker_in_7_I),
    .y8_real_in(ker_in_8_R), .y8_imag_in(ker_in_8_I), .y9_real_in(ker_in_9_R), .y9_imag_in(ker_in_9_I),
    .y10_real_in(ker_in_10_R), .y10_imag_in(ker_in_10_I), .y11_real_in(ker_in_11_R), .y11_imag_in(ker_in_11_I),
    .y12_real_in(ker_in_12_R), .y12_imag_in(ker_in_12_I), .y13_real_in(ker_in_13_R), .y13_imag_in(ker_in_13_I),
    .y14_real_in(ker_in_14_R), .y14_imag_in(ker_in_14_I), .y15_real_in(ker_in_15_R), .y15_imag_in(ker_in_15_I),
    .y16_real_in(ker_in_16_R), .y16_imag_in(ker_in_16_I), .y17_real_in(ker_in_17_R), .y17_imag_in(ker_in_17_I),
    .y18_real_in(ker_in_18_R), .y18_imag_in(ker_in_18_I), .y19_real_in(ker_in_19_R), .y19_imag_in(ker_in_19_I),
    .y20_real_in(ker_in_20_R), .y20_imag_in(ker_in_20_I), .y21_real_in(ker_in_21_R), .y21_imag_in(ker_in_21_I),
    .y22_real_in(ker_in_22_R), .y22_imag_in(ker_in_22_I), .y23_real_in(ker_in_23_R), .y23_imag_in(ker_in_23_I),
    .y24_real_in(ker_in_24_R), .y24_imag_in(ker_in_24_I), .y25_real_in(ker_in_25_R), .y25_imag_in(ker_in_25_I),
    .y26_real_in(ker_in_26_R), .y26_imag_in(ker_in_26_I), .y27_real_in(ker_in_27_R), .y27_imag_in(ker_in_27_I),
    .y28_real_in(ker_in_28_R), .y28_imag_in(ker_in_28_I), .y29_real_in(ker_in_29_R), .y29_imag_in(ker_in_29_I),
    .y30_real_in(ker_in_30_R), .y30_imag_in(ker_in_30_I), .y31_real_in(ker_in_31_R), .y31_imag_in(ker_in_31_I),
    .y32_real_in(ker_in_32_R), .y32_imag_in(ker_in_32_I), .y33_real_in(ker_in_33_R), .y33_imag_in(ker_in_33_I),
    .y34_real_in(ker_in_34_R), .y34_imag_in(ker_in_34_I), .y35_real_in(ker_in_35_R), .y35_imag_in(ker_in_35_I),
    .y36_real_in(ker_in_36_R), .y36_imag_in(ker_in_36_I), .y37_real_in(ker_in_37_R), .y37_imag_in(ker_in_37_I),
    .y38_real_in(ker_in_38_R), .y38_imag_in(ker_in_38_I), .y39_real_in(ker_in_39_R), .y39_imag_in(ker_in_39_I),
    .y40_real_in(ker_in_40_R), .y40_imag_in(ker_in_40_I), .y41_real_in(ker_in_41_R), .y41_imag_in(ker_in_41_I),
    .y42_real_in(ker_in_42_R), .y42_imag_in(ker_in_42_I), .y43_real_in(ker_in_43_R), .y43_imag_in(ker_in_43_I),
    .y44_real_in(ker_in_44_R), .y44_imag_in(ker_in_44_I), .y45_real_in(ker_in_45_R), .y45_imag_in(ker_in_45_I),
    .y46_real_in(ker_in_46_R), .y46_imag_in(ker_in_46_I), .y47_real_in(ker_in_47_R), .y47_imag_in(ker_in_47_I),
    .y48_real_in(ker_in_48_R), .y48_imag_in(ker_in_48_I), .y49_real_in(ker_in_49_R), .y49_imag_in(ker_in_49_I),
    .y50_real_in(ker_in_50_R), .y50_imag_in(ker_in_50_I), .y51_real_in(ker_in_51_R), .y51_imag_in(ker_in_51_I),
    .y52_real_in(ker_in_52_R), .y52_imag_in(ker_in_52_I), .y53_real_in(ker_in_53_R), .y53_imag_in(ker_in_53_I),
    .y54_real_in(ker_in_54_R), .y54_imag_in(ker_in_54_I), .y55_real_in(ker_in_55_R), .y55_imag_in(ker_in_55_I),
    .y56_real_in(ker_in_56_R), .y56_imag_in(ker_in_56_I), .y57_real_in(ker_in_57_R), .y57_imag_in(ker_in_57_I),
    .y58_real_in(ker_in_58_R), .y58_imag_in(ker_in_58_I), .y59_real_in(ker_in_59_R), .y59_imag_in(ker_in_59_I),
    .y60_real_in(ker_in_60_R), .y60_imag_in(ker_in_60_I), .y61_real_in(ker_in_61_R), .y61_imag_in(ker_in_61_I),
    .y62_real_in(ker_in_62_R), .y62_imag_in(ker_in_62_I), .y63_real_in(ker_in_63_R), .y63_imag_in(ker_in_63_I),

    .X0_real_out(ker_out_0_R), .X0_imag_out(ker_out_0_I), .X1_real_out(ker_out_1_R), .X1_imag_out(ker_out_1_I),
    .X2_real_out(ker_out_2_R), .X2_imag_out(ker_out_2_I), .X3_real_out(ker_out_3_R), .X3_imag_out(ker_out_3_I),
    .X4_real_out(ker_out_4_R), .X4_imag_out(ker_out_4_I), .X5_real_out(ker_out_5_R), .X5_imag_out(ker_out_5_I),
    .X6_real_out(ker_out_6_R), .X6_imag_out(ker_out_6_I), .X7_real_out(ker_out_7_R), .X7_imag_out(ker_out_7_I),
    .X8_real_out(ker_out_8_R), .X8_imag_out(ker_out_8_I), .X9_real_out(ker_out_9_R), .X9_imag_out(ker_out_9_I),
    .X10_real_out(ker_out_10_R), .X10_imag_out(ker_out_10_I), .X11_real_out(ker_out_11_R), .X11_imag_out(ker_out_11_I),
    .X12_real_out(ker_out_12_R), .X12_imag_out(ker_out_12_I), .X13_real_out(ker_out_13_R), .X13_imag_out(ker_out_13_I),
    .X14_real_out(ker_out_14_R), .X14_imag_out(ker_out_14_I), .X15_real_out(ker_out_15_R), .X15_imag_out(ker_out_15_I),
    .X16_real_out(ker_out_16_R), .X16_imag_out(ker_out_16_I), .X17_real_out(ker_out_17_R), .X17_imag_out(ker_out_17_I),
    .X18_real_out(ker_out_18_R), .X18_imag_out(ker_out_18_I), .X19_real_out(ker_out_19_R), .X19_imag_out(ker_out_19_I),
    .X20_real_out(ker_out_20_R), .X20_imag_out(ker_out_20_I), .X21_real_out(ker_out_21_R), .X21_imag_out(ker_out_21_I),
    .X22_real_out(ker_out_22_R), .X22_imag_out(ker_out_22_I), .X23_real_out(ker_out_23_R), .X23_imag_out(ker_out_23_I),
    .X24_real_out(ker_out_24_R), .X24_imag_out(ker_out_24_I), .X25_real_out(ker_out_25_R), .X25_imag_out(ker_out_25_I),
    .X26_real_out(ker_out_26_R), .X26_imag_out(ker_out_26_I), .X27_real_out(ker_out_27_R), .X27_imag_out(ker_out_27_I),
    .X28_real_out(ker_out_28_R), .X28_imag_out(ker_out_28_I), .X29_real_out(ker_out_29_R), .X29_imag_out(ker_out_29_I),
    .X30_real_out(ker_out_30_R), .X30_imag_out(ker_out_30_I), .X31_real_out(ker_out_31_R), .X31_imag_out(ker_out_31_I),
    .X32_real_out(ker_out_32_R), .X32_imag_out(ker_out_32_I), .X33_real_out(ker_out_33_R), .X33_imag_out(ker_out_33_I),
    .X34_real_out(ker_out_34_R), .X34_imag_out(ker_out_34_I), .X35_real_out(ker_out_35_R), .X35_imag_out(ker_out_35_I),
    .X36_real_out(ker_out_36_R), .X36_imag_out(ker_out_36_I), .X37_real_out(ker_out_37_R), .X37_imag_out(ker_out_37_I),
    .X38_real_out(ker_out_38_R), .X38_imag_out(ker_out_38_I), .X39_real_out(ker_out_39_R), .X39_imag_out(ker_out_39_I),
    .X40_real_out(ker_out_40_R), .X40_imag_out(ker_out_40_I), .X41_real_out(ker_out_41_R), .X41_imag_out(ker_out_41_I),
    .X42_real_out(ker_out_42_R), .X42_imag_out(ker_out_42_I), .X43_real_out(ker_out_43_R), .X43_imag_out(ker_out_43_I),
    .X44_real_out(ker_out_44_R), .X44_imag_out(ker_out_44_I), .X45_real_out(ker_out_45_R), .X45_imag_out(ker_out_45_I),
    .X46_real_out(ker_out_46_R), .X46_imag_out(ker_out_46_I), .X47_real_out(ker_out_47_R), .X47_imag_out(ker_out_47_I),
    .X48_real_out(ker_out_48_R), .X48_imag_out(ker_out_48_I), .X49_real_out(ker_out_49_R), .X49_imag_out(ker_out_49_I),
    .X50_real_out(ker_out_50_R), .X50_imag_out(ker_out_50_I), .X51_real_out(ker_out_51_R), .X51_imag_out(ker_out_51_I),
    .X52_real_out(ker_out_52_R), .X52_imag_out(ker_out_52_I), .X53_real_out(ker_out_53_R), .X53_imag_out(ker_out_53_I),
    .X54_real_out(ker_out_54_R), .X54_imag_out(ker_out_54_I), .X55_real_out(ker_out_55_R), .X55_imag_out(ker_out_55_I),
    .X56_real_out(ker_out_56_R), .X56_imag_out(ker_out_56_I), .X57_real_out(ker_out_57_R), .X57_imag_out(ker_out_57_I),
    .X58_real_out(ker_out_58_R), .X58_imag_out(ker_out_58_I), .X59_real_out(ker_out_59_R), .X59_imag_out(ker_out_59_I),
    .X60_real_out(ker_out_60_R), .X60_imag_out(ker_out_60_I), .X61_real_out(ker_out_61_R), .X61_imag_out(ker_out_61_I),
    .X62_real_out(ker_out_62_R), .X62_imag_out(ker_out_62_I), .X63_real_out(ker_out_63_R), .X63_imag_out(ker_out_63_I)
);
