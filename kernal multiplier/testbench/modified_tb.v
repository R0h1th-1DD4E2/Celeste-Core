...
module tb_cmpx_mul;
  ...
  initial begin
    ...
    $display("X0_imag = %h", X0_imag); // Display results
    ...
    $display("X8_real = %h", X8_real);
    $display("X8_imag = %h", X8_imag);
    $display("X9_real = %h", X9_real);
    $display("X9_imag = %h", X9_imag);
    $display("X10_real = %h", X10_real);
    $display("X10_imag = %h", X10_imag);
    $display("X11_real = %h", X11_real);
    $display("X11_imag = %h", X11_imag);
    $display("X12_real = %h", X12_real);
    $display("X12_imag = %h", X12_imag);
    $display("X13_real = %h", X13_real);
    $display("X13_imag = %h", X13_imag);
    $display("X14_real = %h", X14_real);
    $display("X14_imag = %h", X14_imag);
    $display("X15_real = %h", X15_real);
    $display("X15_imag = %h", X15_imag);
